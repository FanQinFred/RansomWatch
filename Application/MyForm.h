...
public
	...
	private:
		System::Windows::Forms::CheckBox ^ AutoKill;

	private:
		System::Windows::Forms::CheckBox ^ ViewLog;

	private:
		System::Windows::Forms::CheckBox ^ DisableProtection;

	private:
		System::Windows::Forms::Button ^ SelectAddRootDir;

	private:
		System::Windows::Forms::Button ^ SelectRemRootDir;

	private:
		System::Windows::Forms::PictureBox ^ pictureBox1;

	private:
		System::Windows::Forms::CheckBox ^ Verbose;

	private:
		System::Windows::Forms::Label ^ AppNameTitle;

	private:
		System::Windows::Forms::TextBox ^ logViewer;

	private:
		HRESULT initWorkThread();

	private:
		BOOLEAN openKernelDriverCom();

	private:
		HRESULT AddFilterDirectory(String ^ directory);

	private:
		HRESULT RemoveFilterDirectory(String ^ directory);

	private:
		void closeKernelDriverCom();

	private:
		BOOLEAN openKernelCommunication();
	...
	public:
		MyForm(void)
		{
			...
			if (!openKernelCommunication())
			{ // fail to open communication
...
#pragma endregion
	...
	private:
		System::Void autokill_changed(System::Object ^ sender, System::EventArgs ^ e)
		{
			if (AutoKill->Checked)
			{
	...
	private:
		System::Void viewlog_changed(System::Object ^ sender, System::EventArgs ^ e)
		{
			if (ViewLog->Checked)
			{
	...
	private:
		System::Void DisableProtection_CheckedChanged(System::Object ^ sender, System::EventArgs ^ e)
		{
	...
	private:
		System::Void SelectRemRootDir_Click(System::Object ^ sender, System::EventArgs ^ e)
		{
			...
			if (browseDiag->ShowDialog() == System::Windows::Forms::DialogResult::OK)
			{
				if ((selectedDir = browseDiag->SelectedPath) != nullptr)
				{
					...
					if (Globals::Instance->getCommCloseStat() || context.Port == nullptr)
					{ // no comm
	...
	private:
		System::Void SelectAddRootDir_Click(System::Object ^ sender, System::EventArgs ^ e)
		{
			String ^ selectedDir = nullptr;
			FolderBrowserDialog ^ browseDiag = gcnew FolderBrowserDialog;
	...
	private:
		System::Void Verbose_CheckedChanged(System::Object ^ sender, System::EventArgs ^ e)
		{
			if (Verbose->Checked)
			{
	...
	private:
		System::Void MinimizeButton_Click(System::Object ^ sender, System::EventArgs ^ e)
		{

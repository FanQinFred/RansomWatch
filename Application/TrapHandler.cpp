...
int TrapHandler::initDirTraps(System::String ^ Path)
{
	...
	for (auto &pDir : fs::recursive_directory_iterator(Directory))
	{ //iterate recursively all sub dirs
